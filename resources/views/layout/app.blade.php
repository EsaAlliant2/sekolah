...
<head>
    ...
    <link rel="stylesheet"
        ...
        <!-- {{-- Data Table --}} -->
        <script src="{{asset('asset/datatable/dataTables.bootstrap4.min.css')}}"></script>
        <script src="{{asset('asset/datatable/responsive.bootstrap4.min.css')}}"></script>
        <script src="{{asset('asset/datatable/buttons.bootstrap4.min.css')}}"></script>
